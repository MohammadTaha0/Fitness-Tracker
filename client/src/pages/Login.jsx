...
export default function Login({ handleLogin, btn, email, setEmail, password, setPassword }) {
  ...
  return (
    <div className='min-h-100-vh row mx-0 px-0 align-items-center'>
      ...
      <form className='row row-cols-1 mx-0 col-md-4 col-sm-7 col-11 mx-auto shadow border rounded-3 gy-3 p-0 pb-4' onSubmit={(e) => {e.preventDefault();handleLogin(email, password);}}>
